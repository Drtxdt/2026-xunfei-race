...
class CompetitionLogicTest(unittest.TestCase):
    ...
    def test_task2_coverage_navigation_has_cone_safety_limits(self):
        ...
        self.assertIn("coverage_max_vel_x: 0.45", config)
        self.assertIn("coverage_max_vel_y: 0.40", config)
        self.assertIn("coverage_max_vel_theta: 0.90", config)
        self.assertIn("coverage_cruise_vel_x: 0.40", config)
        self.assertIn("coverage_cruise_vel_theta: 0.80", config)
        self.assertIn("coverage_caution_vel_x: 0.25", config)
        self.assertIn("coverage_caution_vel_theta: 0.55", config)
        self.assertIn("coverage_escape_max_attempts: 2", config)
        self.assertIn("coverage_max_consecutive_skips: 1", config)
