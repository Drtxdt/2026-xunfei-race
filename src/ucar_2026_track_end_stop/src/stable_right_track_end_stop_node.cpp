...
private:
  ...
  void loadParams()
  {
    ...
    private_nh_.param("kp", kp_, 0.0040);
    private_nh_.param("kd", kd_, 0.0006);
    private_nh_.param("error_alpha", error_alpha_, 0.34);
    ...
    private_nh_.param("steering_deadband_px", steering_deadband_px_, 4.0);
    private_nh_.param("max_straight_angular_speed", max_straight_angular_speed_, 0.16);
    private_nh_.param("max_right_angular_speed", max_right_angular_speed_, 0.36);
    private_nh_.param("straight_angular_alpha", straight_angular_alpha_, 0.55);
    private_nh_.param("curve_angular_alpha", curve_angular_alpha_, 0.30);
    private_nh_.param("straight_angular_step", straight_angular_step_, 0.04);
    private_nh_.param("curve_angular_step", curve_angular_step_, 0.075);
    private_nh_.param("right_guard_error_px", right_guard_error_px_, 55.0);
    private_nh_.param("right_guard_speed", right_guard_speed_, 0.09);
    private_nh_.param("right_guard_max_angular_speed", right_guard_max_angular_speed_, 0.36);
    private_nh_.param("recovering_angular_gain", recovering_angular_gain_, 0.88);
    private_nh_.param("reverse_brake_factor", reverse_brake_factor_, 0.60);
  ...
  double kp_ = 0.0040;
  double kd_ = 0.0006;
  double error_alpha_ = 0.34;
  double curve_error_threshold_ = 38.0;
  double curve_angular_gain_ = 1.00;
  double max_angular_speed_ = 0.38;
  double steering_deadband_px_ = 4.0;
  double max_straight_angular_speed_ = 0.16;
  double max_right_angular_speed_ = 0.36;
  double straight_angular_alpha_ = 0.55;
  double curve_angular_alpha_ = 0.30;
  double straight_angular_step_ = 0.04;
  double curve_angular_step_ = 0.075;
  double right_guard_error_px_ = 55.0;
  double right_guard_speed_ = 0.09;
  double right_guard_max_angular_speed_ = 0.36;
  double recovering_angular_gain_ = 0.88;
  double reverse_brake_factor_ = 0.60;
